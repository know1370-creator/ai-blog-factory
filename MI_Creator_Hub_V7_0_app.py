...
.stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:16px}.stat{background:var(--soft);border:1px solid #e8e5ff;border-radius:14px;padding:16px}.stat strong{display:block;font-size:28px;margin-bottom:4px}.copy-box{position:relative}.copy-btn{margin-top:7px;background:#edf0f4;color:#202124}.calendar-item{padding:14px 0;border-bottom:1px solid var(--line)}.money-box{border:1px solid #f0d9a7;background:#fffaf0;border-radius:14px;padding:18px}.notice{font-size:13px;color:var(--muted);background:#f7f8fc;border-radius:9px;padding:10px}.toggle{display:flex;align-items:center;gap:9px;margin-top:14px}.toggle input{width:auto}.score{font-size:46px;font-weight:900}.check{padding:10px 0;border-bottom:1px solid var(--line)}.pass{color:var(--ok);font-weight:800}.fail{color:var(--bad);font-weight:800}.tags{display:flex;gap:7px;flex-wrap:wrap}.tag{background:var(--soft);color:#5046b8;padding:7px 10px;border-radius:99px}
...
def home():
    ...
    return page("""
<div class="card">
<h1>MI Creator Hub <span class="status">V7.0</span></h1>

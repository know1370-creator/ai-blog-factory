...
def home():
    ...
    return page("""
<div class="card">
<h1>MI Creator Hub <span class="status">V12.0</span></h1>
<p class="lead">키워드 하나로 글, SEO, 썸네일, Blogger 발행과 수익화 링크까지 한 흐름으로 만들어요.</p>
<div class="actions"><a class="btn" href="{{url_for('generator_v12.dashboard')}}">AI 프로젝트 자동 생성</a><a class="btn gray" href="{{url_for('library_v11.dashboard')}}">콘텐츠 라이브러리</a><a class="btn gray" href="{{url_for('manager_v10.dashboard')}}">AI 콘텐츠 매니저</a><a class="btn gray" href="{{url_for('social_v96.dashboard')}}">AI 소통 비서</a><a class="btn gray" href="{{url_for('analytics_v95.dashboard')}}">성과 분석</a><a class="btn gray" href="{{url_for('diagnostics_v95.dashboard')}}">시스템 점검</a><a class="btn gray" href="{{url_for('calendar_v94.dashboard')}}">콘텐츠 캘린더</a><a class="btn gray" href="{{url_for('planner_v93.dashboard')}}">주간 콘텐츠 플래너</a><a class="btn gray" href="{{url_for('assistant_v92.dashboard')}}">AI 콘텐츠 비서</a><a class="btn gray" href="{{url_for('business_v91.dashboard')}}">수익 대시보드</a><a class="btn gray" href="{{url_for('content_calendar')}}">콘텐츠 캘린더</a><a class="btn gray" href="{{url_for('idea_lab')}}">AI 아이디어 연구소</a></div>
<div class="stat-grid">

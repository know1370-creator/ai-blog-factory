...
def home():
    ...
    return page("""
<div class="card">
<h1>MI Creator Hub <span class="status">V8.0</span></h1>
<p class="lead">키워드 하나로 글, SEO, 썸네일, Blogger 발행과 수익화 링크까지 한 흐름으로 만들어요.</p>
<div class="actions"><a class="btn gray" href="{{url_for('content_calendar')}}">콘텐츠 캘린더</a><a class="btn gray" href="{{url_for('idea_lab')}}">AI 아이디어 연구소</a></div>
<div class="stat-grid">
